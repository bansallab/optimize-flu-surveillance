...
## Epidemic intensity model at the county level: CAR spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms
## Model code is the same for total population, adults, and children epidemic intensity models. Input data differs among the populations.
...
#### FILEPATHS #################################
file_dataImport <- "inlaImport_model8a_iliSum_v7.csv" ## change input file for total, adult, and child populations
path_adjMxExport_cty <- "../US_county_adjacency.graph"
